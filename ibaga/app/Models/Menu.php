...
class Menu extends Model
{
    ...
    public static function display($menuName, $type = null, array $options = [])
    {
        ...
        $menu = \Cache::remember(self::PREFIX.$menuName, \Carbon\Carbon::now()->addDays(30), function () use ($menuName) {
    ...
    {
        \Cache::forget(self::PREFIX.$this->name);
    }
