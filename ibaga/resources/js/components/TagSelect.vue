    ...
    <div>
        ...
        <div class="tags">
            <template v-for="(tags, index) in value">
                <input hidden type="hidden" :form="form" :name="`tags[${index}][name]`" :value="tags.name">
                <input hidden type="hidden" :form="form" :name="`tags[${index}][slug]`" :value="tags.slug">
            </template>
        </div>
    </div>
</template>
