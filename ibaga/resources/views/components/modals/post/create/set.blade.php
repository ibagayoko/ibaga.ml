...
<div class="settings-menu-container settings-menu-expanded ">
            ...
            <div class="settings-menu-pane-in  settings-menu settings-menu-pane">
                <div class="settings-menu-header">
                    ...
                    <button class="close settings-menu-header-action" data-ember-action="" data-ember-action-164="164">
                        <svg version="1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12.707 12L23.854.854a.5.5 0 0 0-.707-.707L12 11.293.854.146a.5.5 0 0 0-.707.707L11.293 12 .146 23.146a.5.5 0 0 0 .708.708L12 12.707l11.146 11.146a.5.5 0 1 0 .708-.706L12.707 12z"></path></svg><span class="hidden">Close</span>
                    </button>
                </div>
        ...
        <div class="progress-container">
            ...
            <button class="gh-btn gh-btn-green" data-ember-action="" data-ember-action-416="416"><span>Try Again</span></button>
    ...
    <!----></section>
                    ...
                    <div class="form-group">
                        <label for="url">Post URL</label>
                            <a class="post-view-link" target="_blank" href="http://localhost:2368/p/487f494c-16fe-444f-b428-a66cbdbd2207/">
                                Preview <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><path d="M24 24H8V8.062l4-.063v-4H4v24h24v-10h-4zM16 4l4 4-6 6 4 4 6-6 4 4V4z"></path></svg>
                            </a>
    ...
    </div>  <div id="ember-basic-dropdown-content-ember172" class="ember-basic-dropdown-content-placeholder" style="display: none;"></div>
    ...
    <div aria-owns="ember-basic-dropdown-content-ember180" tabindex="0" data-ebd-id="ember180-trigger" role="button" id="tag-input" class="ember-power-select-trigger ember-power-select-multiple-trigger ember-basic-dropdown-trigger ember-basic-dropdown-trigger--in-place ember-view"><ul id="ember-power-select-multiple-options-ember180" class="ember-power-select-multiple-options sortable-objects ember-view"><!---->
      ...
      <div id="ember-basic-dropdown-content-ember180" class="ember-basic-dropdown-content-placeholder" style="display: none;"></div>
    ...
    <div aria-owns="ember-basic-dropdown-content-ember190" tabindex="0" data-ebd-id="ember190-trigger" role="button" id="author-list" class="ember-power-select-trigger ember-power-select-multiple-trigger ember-basic-dropdown-trigger ember-basic-dropdown-trigger--in-place ember-view"><ul id="ember-power-select-multiple-options-ember190" class="ember-power-select-multiple-options sortable-objects ember-view"><li draggable="true" id="ember201" class="ember-power-select-multiple-option js-draggableObject draggable-object ember-view">                                    ndsjjnk
                    ...
                    <span role="button" aria-label="remove element" class="ember-power-select-multiple-remove-btn" data-selected-index="0">
                        <svg version="1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-selected-index="0"><path d="M12.707 12L23.854.854a.5.5 0 0 0-.707-.707L12 11.293.854.146a.5.5 0 0 0-.707.707L11.293 12 .146 23.146a.5.5 0 0 0 .708.708L12 12.707l11.146 11.146a.5.5 0 1 0 .708-.706L12.707 12z"></path></svg>
                    </span>
    
    </li>
            <input class="ember-power-select-trigger-multiple-input" tabindex="0" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" id="ember-power-select-trigger-multiple-input-ember190" aria-controls="ember-power-select-options-ember190" style="width: 25px" placeholder="" type="search">
    </ul><span class="ember-power-select-status-icon"></span>
    </div>
      <div id="ember-basic-dropdown-content-ember190" class="ember-basic-dropdown-content-placeholder" style="display: none;"></div>
                    ...
                    <ul class="nav-list nav-list-block">
                        <li class="nav-list-item" data-ember-action="" data-ember-action-194="194">
                            <button type="button">
                                <b>Meta Data</b>
                        ...
                        <li class="nav-list-item" data-ember-action="" data-ember-action-195="195">
                            <button type="button">
                                <b>Twitter Card</b>
                        ...
                        <li class="nav-list-item" data-ember-action="" data-ember-action-196="196">
                            <button type="button">
                                <b>Facebook Card</b>
                        ...
                        <li class="nav-list-item" data-ember-action="" data-ember-action-197="197">
                            <button type="button">
                                <b>Code Injection</b>
                    ...
                    <div class="form-group for-checkbox">
                        <label class="checkbox" for="featured" data-ember-action="" data-ember-action-198="198">
                            <input class="gh-input post-settings-featured" type="checkbox">
                            <span class="input-toggle-component"></span>
                            <p class="liquid-tether-target liquid-tether-element-attached-middle liquid-tether-element-attached-center liquid-tether-target-attached-middle liquid-tether-enabled">Feature this post</p>
                        </label>
                    </div>
    
                    <!---->
    
                        <button class="gh-btn gh-btn-link gh-btn-icon settings-menu-delete-button" type="button" data-ember-action="" data-ember-action-253="253"><span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><path d="M30.688 4H22V.687a.694.694 0 0 0-.688-.688H10.687a.694.694 0 0 0-.688.688V4H1.311c-.375 0-.625.313-.625.688s.25.625.625.625h3.375v26c0 .375.25.688.625.688h21.375c.375 0 .625-.313.625-.688v-26h3.375c.375 0 .625-.25.625-.625S31.061 4 30.686 4zM11.313 1.313h9.375v2.688h-9.375zM26 30.688H6V5.313h20zM10.688 9.313a.694.694 0 0 0-.688.688v15.313c0 .375.313.688.688.688s.625-.313.625-.688V10.001c0-.375-.25-.688-.625-.688zm5.312 0a.694.694 0 0 0-.688.688v15.313c0 .375.313.688.688.688s.688-.313.688-.688V10.001A.694.694 0 0 0 16 9.313zm4.688.687v15.313c0 .375.25.688.625.688s.688-.313.688-.688V10c0-.375-.313-.688-.688-.688s-.625.313-.625.688z"></path></svg> Delete Post</span></button>
            ...
            <div class="settings-menu-pane-out-right settings-menu settings-menu-pane">
                <div class="active">
                        <div class="settings-menu-header subview">
                                <button class="back settings-menu-header-action" data-ember-action="" data-ember-action-730="730"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><path fill="#010101" d="M37.802 46.247L12.376 24 37.801 1.753A1 1 0 1 0 36.484.247l-26.286 23a1.004 1.004 0 0 0 .001 1.506l26.286 23a.997.997 0 0 0 1.411-.095 1 1 0 0 0-.094-1.411z"></path></svg><span class="hidden">Back</span></button>
                                <h4>Meta Data</h4>
        ...
        <div id="ember735" class="form-group ember-view">                                    <label for="canonicalUrl">Canonical URL</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="seo-preview">
                                                <div class="seo-preview-title">hkjnlkfnnm</div>
                                                <div class="seo-preview-link">http://localhost:2368/hkjnlkfnnm/</div>
    ...
    <!---->            </div>
                    <div class="twitter">
                        <div class="settings-menu-header subview">
                            <button class="back settings-menu-header-action" data-ember-action="" data-ember-action-752="752"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48"><path fill="#010101" d="M37.802 46.247L12.376 24 37.801 1.753A1 1 0 1 0 36.484.247l-26.286 23a1.004 1.004 0 0 0 .001 1.506l26.286 23a.997.997 0 0 0 1.411-.095 1 1 0 0 0-.094-1.411z"></path></svg><span class="hidden">Back</span></button>
                            <h4>Twitter Card</h4>
                            <div style="width:23px;"></div>
                        </div>
                                ...
                                <div id="ember753" class="ember-view">    
                                    <section id="ember754" class="gh-image-uploader ember-view">    
                                        <div class="upload-form">
                                            ...
                                            <div class="gh-image-uploader-unsplash" data-ember-action="" data-ember-action-756="756">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.43 122.41"><path d="M83.86 54.15v34.13H38.57V54.15H0v68.26h122.43V54.15H83.86zM38.57 0h45.3v34.13h-45.3z"></path></svg>
                                            </div>
                                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="gh-twitter-preview">
                                    <div class="gh-twitter-preview-content">
                                        <div class="gh-twitter-preview-title">hkjnlkfnnm</div>
                                        <div class="gh-twitter-preview-description"></div>
            ...
            <!-- en twitter-->            
                <div class="faebook">
                    ...
                    <!---->
                    <div class="settings-menu-header subview">
                        <button class="back settings-menu-header-action" data-ember-action="" data-ember-action-775="775"><svg
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
                                <path fill="#010101"
                                    d="M37.802 46.247L12.376 24 37.801 1.753A1 1 0 1 0 36.484.247l-26.286 23a1.004 1.004 0 0 0 .001 1.506l26.286 23a.997.997 0 0 0 1.411-.095 1 1 0 0 0-.094-1.411z">
                                </path>
                            </svg><span class="hidden">Back</span></button>
                        <h4>Facebook Card</h4>
                        <div style="width:23px;"></div>
                    </div>
                            ...
                            <div id="ember776" class="ember-view">
                                <section id="ember777" class="gh-image-uploader ember-view">
                                    <div class="upload-form">
                                        ...
                                        <div class="gh-image-uploader-unsplash" data-ember-action="" data-ember-action-779="779">
                            ...
                            <div class="form-group">
                                ...
                                <div class="gh-og-preview">
                                    ...
                                    <div class="gh-og-preview-content">
                                        <div class="gh-og-preview-title">hkjnlkfnnm</div>
                                        <div class="gh-og-preview-description"></div>
                                        <div class="gh-og-preview-footer">
                                            <div class="gh-og-preview-footer-left">
                                                localhost:2368 <span class="gh-og-preview-footer-left-divider">|</span> by <span
                                                    class="gh-og-preview-footer-author">ndsjjnk</span>
                                            </div>
