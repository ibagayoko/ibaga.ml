...
<html>
  ...
  <body class="app">
    ...
    <script>
      function toggleEmailView(target){

// }
// $('.email-list-item').on('click', e => {
  let email  = JSON.parse(target.dataset.email)
  document.querySelector('.email-content').classList.toggle('open');
  ...
  let content = `
                    ...
                    <div class="bdT pX-40 pY-30">
                      ...
                      // </div>
  document.querySelector('#email-content-wrapper').innerHTML = content
//   e.preventDefault();
}
    </script>
  </body>
